"""
Run MicroPhys-BMS (phase2) on Stanford LFP and CALCE A123 datasets.
...
# Add phase2 folder to python path to import phase2_master_validation
...
def run_microphys_on_csv(csv_path, dataset_name, out_dir):
    """Run MicroPhys-BMS on a CSV file."""
...
if __name__ == "__main__":
    ...
    if not os.path.exists(stanford_csv):
        # Fallback search path if baseline folder is structured differently
        stanford_csv = os.path.join(REPO_ROOT, "..", "baseline", "features_all_temperatures.csv")
